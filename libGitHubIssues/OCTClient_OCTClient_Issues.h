...
- (RACSignal *)createIssueCommentWithBody:(NSString *)body forIssue:(id)issue inRepository:(OCTRepository *)repository;
...
- (RACSignal *)fetchIssueCommentsForIssue:(id)issue since:(NSDate*)since;
